...
- **Navigation: freier Startpunkt + „Losfahren"-Deeplink.** Routen gingen bisher immer vom aktuellen Standort aus. Jetzt:
  ...
  - **Kompaktere Aktions-Buttons**: die sekundären Panel-Aktionen (Losfahren, Von hier, Bearbeiten, Löschen, OpenStreetMap) liegen jetzt in einem 2-Spalten-Raster statt full-width gestapelt — spart Höhe, seit das Panel viele Funktionen hat.
